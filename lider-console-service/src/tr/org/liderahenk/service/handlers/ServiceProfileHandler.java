...
import tr.org.liderahenk.service.dialogs.ServiceProfileDialog;
...
/**
 * Profile definition handler for service plugin.
 *
 */
public class ServiceProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(ServiceProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("Service"), ServiceConstants.PLUGIN_NAME, 
					ServiceConstants.PLUGIN_VERSION, new ServiceProfileDialog()), 
