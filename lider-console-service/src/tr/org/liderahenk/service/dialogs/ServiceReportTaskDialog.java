...
public class ServiceReportTaskDialog extends DefaultTaskDialog {
	...
	labelRecordDate.setText(Messages.getString("DATE") + " "
	...
	lblAgent.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
			false, 1, 1));
	lblAgent.setText(Messages.getString("agent")); //$NON-NLS-1$

	textAgent = new Text(grpOnlineUsr, SWT.BORDER);
	GridData gd_textAgent = new GridData(SWT.LEFT, SWT.CENTER, false,
			false, 1, 1);
	...
	GridData gd_textPackageName = new GridData(SWT.LEFT, SWT.CENTER, false,
			false, 1, 1);
	...
	combo.setLayoutData(gd_combo);
			...
			GridData gd_btnFilter = new GridData(SWT.LEFT, SWT.FILL, false, false,
					1, 1);
			...
			btnExportToPDF.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true,
					false, 1, 1));
	...
	composite = new Composite(grpOnlineUsr, SWT.BORDER
			| SWT.SHADOW_IN);
